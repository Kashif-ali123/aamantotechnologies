        ...
        <section className="scientist-area bg-color pb-70">
            <div className="container">
                ...
                <div className="content">
                                ...
                                <p style={{textAlign:"justify"}}>We take the time to understand and analyze our client needs and their time to market strategy.</p>
                            ...
                            <div className="image" >
                                <img src={scientist1} alt="about"  style={{marginTop:"90px", backgroundColor:"#fff", width:"300px"}} />
                            </div>
                            {/* <div className="content">
                                <h3>Merv Adrian</h3>
                    ...
                    <div className="col-lg-3 col-sm-6 col-md-6">
                        <div className="single-scientist-box">
                            ...
                            <div className="content">
                                ...
                                <p style={{textAlign:"justify"}}>We use well defined and innovative thinking strategy to develop agile plan to address client goals with keeping in mind time, scope and budget.</p>
                            ...
                            <div className="image">
                                <img src={scientist2} alt="about"  style={{marginTop:"30px", backgroundColor:"#fff", width:"300px"}} />
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-sm-6 col-md-6">
                    ...
                    {/* <div className="col-lg-3 col-sm-6 col-md-6">
                        <div className="single-scientist-box"> */}
                            <div className="image">
                                <img src={scientist3} alt="about" style={{marginTop:"60px", backgroundColor:"#fff", width:"300px"}} />
                            </div>
                            {/* <div className="content">
                                <h3>Carla Gentry</h3>
                    ...
                    <div className="col-lg-3 col-sm-6 col-md-6">
                        <div className="single-scientist-box">
                            ...
                            <div className="content">
                                ...
                                <p style={{textAlign:"justify"}}>Orchestration of technology in heterogeneous systems, potentially servicing a global cloud deployment in different geographical locations and with different providers.</p>
                            ...
                            <div className="image">
                                <img src={scientist4} alt="about" style={{backgroundColor:"#fff", width:"300px"}}  />
                            </div>
                        </div>
                    </div>
                </div>
